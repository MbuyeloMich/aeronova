...
import { AircraftPhysics, AircraftInput, AircraftConfig as AircraftPhysicsConfig } from './AircraftPhysics';

interface AircraftConfig extends VehicleConfig {
  physics?: Partial<AircraftPhysicsConfig>;
}
...
export class Aircraft extends Vehicle {
  ...
  constructor(id: string, config: AircraftConfig) {
    super(id, config);
    const physicsConfig: AircraftPhysicsConfig = {
      minSpeed: 15,
      maxSpeed: 1200,
      speedChangeRate: 25,
    ...
    this.physics = new AircraftPhysics({
      ...
      speedChangeRate: physicsConfig.speedChangeRate,
      turnRate: physicsConfig.turnRate,
      climbRate: physicsConfig.climbRate,
      gravity: physicsConfig.gravity,
      rollRate: physicsConfig.rollRate,
      maxRoll: physicsConfig.maxRoll,
      pitchRate: physicsConfig.pitchRate,
      maxPitch: physicsConfig.maxPitch
    }, this.hpRoll.heading);
  }
