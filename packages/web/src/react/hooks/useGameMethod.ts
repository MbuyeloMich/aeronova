...
import type { AircraftPreset } from '../../cesium/managers/VehicleManager';
...
export function useGameMethod() {
  ...
  return {
    ...
    getAircraftPresets: (): AircraftPreset[] => bridge.getAircraftPresets(),
    getActiveAircraftPresetId: (): string => bridge.getActiveAircraftPresetId(),
    setAircraftPreset: (presetId: string) => bridge.setAircraftPreset(presetId),
